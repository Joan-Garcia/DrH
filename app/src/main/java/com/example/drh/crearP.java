...
public class crearP extends Fragment {
    ...
    View vista;
    Button btnCrearP;
    EditText et_Nombre, et_APater, et_AMater, et_Domicilio, et_Colonia, et_Ciudad, et_Estado, et_CP,
            et_Pais, et_TelFijo, et_TelCel, et_Correo, et_Contra, et_ConfContra, et_tipoUsuario;
    ...
    public void asignaciones(View v) {
        ...
        btnCrearP.setOnClickListener(v1 -> {
            obtenerDatos();
            if (validar()) {
